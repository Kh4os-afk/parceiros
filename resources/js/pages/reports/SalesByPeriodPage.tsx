        ...
        <div className="flex flex-col gap-5 animate-[fade-in_0.2s_ease-out]">
            ...
            <div className="relative bg-card border border-(--border) overflow-hidden">
                ...
                {corners.map((cls, i) => (
                    <div
                        key={i}
                        className={`absolute w-4 h-4 border-(--primary)/30 ${cls}`}
                    />
                ))}
                    ...
                    >
                        {[
                            ...
                            <div key={id} className="flex flex-col gap-1.5">
                                ...
                                />
                                {err?.[0] && (
                                    <p className="text-[0.62rem] text-(--destructive)">
                                        {err[0]}
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            {[
                                ...
                                },
                                {
                                    ...
                                    amount: totalCompras,
                                    decimals: 0,
                                    sub: `média de ${(totalCompras / results.length).toFixed(1)} por funcionário`,
                                    icon: ReceiptText,
                                    highlight: false,
                                },
                                {
                                    label: "Maior Comprador",
                                    amount: maiorComp?.total ?? 0,
                                    sub: maiorComp
                                        ? toTitleCase(maiorComp.nome)
                                        : "—",
                                    icon: Award,
                                    highlight: false,
                                },
                                ...
                                ({
                                    ...
                                    >
                                        <div
                                            className={`absolute top-0 left-0 right-0 h-0.5 bg-(--primary) transition-opacity duration-200 ${highlight ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                                        />
                                        ...
                                        <p
                                            className={`font-black leading-none mb-1.5 transition-colors duration-200 ${highlight ? "text-xl text-(--primary)" : "text-lg text-(--foreground) group-hover:text-(--primary)"}`}
                                        >
                                            {decimals === 2 && (
