        ...
        <div style={{ height: "100dvh", overflow: "hidden" }}>
            <AnimatePresence mode="wait">
                ...
                {!partner && (
                    ...
                    >
                        ...
                        <div className="relative flex flex-col flex-1 max-w-md mx-auto w-full px-6 py-10">
                            ...
                            {!loading && (
                                <motion.p
                                    className="mt-auto pt-10 text-center text-white/30 text-[0.5rem] uppercase tracking-[0.25em]"
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                ...
                {partner && (
                    ...
                    >
                        {/* Header compacto com gradiente + Nova Consulta */}
                        <div
                            ...
                            >
                                ...
                                {!partner.bloqueado && (
                                    <div className="mt-6 max-w-xs mx-auto">
                                        <div className="h-2.5 bg-muted w-full mb-2 overflow-hidden">
                                            <motion.div
                                                className="h-full"
                                                initial={{ width: 0 }}
                                                animate={{ width: `${pct}%` }}
