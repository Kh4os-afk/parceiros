...
export default function SaldoPage() {
    ...
    return (
        <div style={{ height: "100dvh", overflow: "hidden" }}>
            {/* ══════════ HERO / BUSCA — ocupa 100dvh enquanto não há resultado ══════════ */}
            {!partner && (
                <div
                    ...
                    style={{
                        height: "100dvh",
                        background:
                            "linear-gradient(42deg, #ff2222, #00c245f0)",
                    }}
                >
                    {/* Dot grid */}
                    <div
                    ...
                    <div className="relative flex flex-col flex-1 max-w-md mx-auto w-full px-6 py-10">
                        ...
                        <div className="flex items-center gap-3 mb-auto">
                            ...
                            <div>
                                ...
                                <p className="text-white font-black text-[0.88rem] uppercase tracking-wide">
                                    Baratão da Carne
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-10 mb-8">
                            ...
                            <p className="text-white/60 text-[0.65rem] leading-relaxed max-w-xs">
                                Digite seu CPF para ver o limite disponível e o
                        ...
                        >
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    inputMode="numeric"
                                    maxLength={14}
                                    className="w-full bg-white/12 border-2 border-white/25 text-white placeholder:text-white/30 px-4 py-1.5 text-xl font-mono tracking-[0.18em] outline-none focus:border-white/60 focus:bg-white/18 transition-all"
                                />
                                {notFound && (
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-white py-3 text-[0.65rem] font-black uppercase tracking-[0.22em] disabled:opacity-40 hover:opacity-90 transition-opacity mt-1"
                                style={{ color: "#cc1111" }}
                            >
                                {loading ? (
                                    <>
            ...
            {/* ══════════ RESULTADO — ocupa 100dvh quando encontrado ══════════ */}
            {partner && (
                <div
                    ref={resultRef}
                ...
                >
                    {/* Header compacto com gradiente + botão Nova Consulta */}
                    <div
                        className="sticky top-0 z-20 flex items-center justify-between px-5 py-3 shrink-0"
                        style={{
                            background:
                                "linear-gradient(42deg, #ff2222, #00c245f0)",
                        }}
                    >
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <p className="text-white/60 text-[0.38rem] uppercase tracking-[0.4em]">
                                    Sistema de Convênio
                                </p>
                                <p className="text-white font-black text-[0.72rem] uppercase tracking-wide leading-none">
                                    Baratão da Carne
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            className="flex items-center gap-1.5 bg-white/15 border border-white/25 px-3 py-1.5 text-white text-[0.52rem] font-black uppercase tracking-widest hover:bg-white/25 transition-colors"
                        >
                            <Search size={10} />
                            Nova Consulta
                        </button>
                    ...
                    <div className="bg-muted flex flex-col gap-0 max-w-md mx-auto w-full">
                        ...
                        <div className="bg-card border-b border-(--border) px-5 py-4 flex items-center justify-between gap-3">
                            <div className="min-w-0">
                                <p className="text-[0.46rem] uppercase tracking-[0.28em] text-(--muted-foreground) mb-0.5">
                                    Funcionário
                                </p>
                        ...
                        <div className="bg-card px-5 py-8 text-center border-b border-(--border)">
                            ...
                            {partner.bloqueado ? (
                                <p className="text-xl font-black text-red-500 uppercase">
                                    Acesso suspenso
                                </p>
                            ) : (
                                <p
