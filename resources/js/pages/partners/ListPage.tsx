            ...
            <div className="relative bg-card border border-(--border) overflow-hidden">
                ...
                <div className="relative grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 border-t border-(--border)">
                    {[
                        ...
                        <div
                            key={label}
                            className="group relative px-4 md:px-6 py-3.5 border-r border-b border-(--border) bg-muted hover:bg-card cursor-default transition-colors duration-150 overflow-hidden"
                        >
                            <div
                        ...
                        <tbody>
                            {loading ? (
                                <tr>
                                    <td
                                        colSpan={isAdmin ? 7 : 6}
                                        className="text-center py-14 text-[0.75rem] text-(--muted-foreground)"
                                    >
                                        Carregando…
                                    </td>
                                </tr>
