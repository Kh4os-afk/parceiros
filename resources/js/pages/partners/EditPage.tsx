            ...
            <div className="bg-white border border-[var(--border)]">
                ...
                <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                value={form.cpf}
                                disabled
                                className="border border-[var(--border)] px-3 py-2 text-sm bg-[oklch(0.94_0_0)] text-[var(--muted-foreground)] tracking-widest opacity-60 cursor-not-allowed"
                            />
                            <p className="text-[0.58rem] text-[var(--muted-foreground)]">CPF não pode ser alterado</p>
                        </div>
                        <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex justify-end gap-2 pt-2 border-t border-[var(--border)] mt-1">
                        <button type="button" onClick={() => navigate('/funcionarios')} className="border border-[var(--border)] px-5 py-2 text-[0.68rem] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors">
                            Cancelar
                        </button>
